    ...
    render() {
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <label>
                Titel: <br/>
                <input name="title" className={this.state.title} type="text" value={this.state.report["title"] || ""} onChange={this.fieldChange.bind(this, "title")} />
                </label><br/>

                <label>
                Beskrivning: <br/>
                <textarea rows="25" cols="70" name="description" className={this.state.description} type="text" value={this.state.report["description"] || ""} onChange={this.fieldChange.bind(this, "description")} />
                </label><br/>
